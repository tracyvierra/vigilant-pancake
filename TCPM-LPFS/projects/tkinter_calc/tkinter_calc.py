...
Button(root, text="1", padx=5, pady=5).grid(row=2, column=0)
Button(root, text="2", padx=5, pady=5).grid(row=2, column=1)
Button(root, text="3", padx=5, pady=5).grid(row=2, column=2)
...
Button(root, text="4", padx=5, pady=5).grid(row=3, column=0)
Button(root, text="5", padx=5, pady=5).grid(row=3, column=1)
Button(root, text="6", padx=5, pady=5).grid(row=3, column=2)
...
Button(root, text="7", padx=5, pady=5).grid(row=4, column=0)
Button(root, text="8", padx=5, pady=5).grid(row=4, column=1)
Button(root, text="9", padx=5, pady=5).grid(row=4, column=2)

# adding other buttons 0, +, _, *, /, =, and clear

Button(root, text="AC", padx=5, pady=5).grid(row=5, column=0)
Button(root, text="0", padx=5, pady=5).grid(row=5, column=1)
Button(root, text="=", padx=5, pady=5).grid(row=5, column=2)

Button(root, text="+", padx=5, pady=5).grid(row=2, column=3)
...
Button(root, text="(*)", padx=5, pady=5).grid(row=4, column=4)
Button(root, text="EXP", padx=5, pady=5).grid(row=5, column=4)

# Button(root, text="", padx=20, pady=20).grid(row=4, column=0)
# Button(root, text="", padx=20, pady=20).grid(row=4, column=1)
# Button(root, text="", padx=20, pady=20).grid(row=4, column=2)
