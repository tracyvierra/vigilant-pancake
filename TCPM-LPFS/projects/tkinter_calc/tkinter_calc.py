...
Button(root, text="AC", padx=4, pady=5).grid(row=5, column=0)
...
Button(root, text="(", padx=6, pady=5).grid(row=4, column=4)
...
Button(root, text="<-", padx=5, pady=5).grid(row=2, column=5)
Button(root, text="x!", padx=5, pady=5).grid(row=3, column=5)
Button(root, text=")", padx=6, pady=5).grid(row=4, column=5)
